        ...
        <>
            <div className="LandingBody">    
                ...
                <div className="introduction">
                    <div className="outDoor">
                        <div className="outDoorTitulo">
                          <h1><span className="outDoor-span">Unlock</span> Your <br/> Potencial With <br/> <span className="outDoor-span">Knowledge</span>: Learn, <br/> Grow, Succeed</h1>
                        </div>
                ...
                <div className="content">
                    <div className="landing-banner-One" id="outDoor-home">
                        ...
                        <div className="banner-info">
                            ...
                            <h1>Access to learning <br/> anytime & anyware</h1>

...
interface ptNavItem {
  ptId: string
  ptLabel: string
  ptIcon: React.ReactNode
}

interface ptNavSection {
  ptTitle: string | null
  ptItems: ptNavItem[]
}
...
function ptIconClip() {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M20 4L8.5 15.5M14.5 14.5L20 20" />
    </svg>
  )
}
function ptIconCommunity() {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
const ptNavSections: ptNavSection[] = [
  {
    ptTitle: null,
    ptItems: [{ ptId: "home", ptLabel: "Home", ptIcon: ptIconHome() }],
  },
  {
    ptTitle: "APRENDER",
    ptItems: [
      { ptId: "videos", ptLabel: "Vídeos", ptIcon: ptIconVideo() },
      { ptId: "livros", ptLabel: "Livros", ptIcon: ptIconBook() },
      { ptId: "transcricoes", ptLabel: "Transcrições", ptIcon: ptIconTranscript() },
      { ptId: "clips", ptLabel: "Clips", ptIcon: ptIconClip() },
    ],
  },
  {
    ptTitle: "COMUNIDADE",
    ptItems: [
      { ptId: "comunidade", ptLabel: "Comunidade", ptIcon: ptIconCommunity() },
      { ptId: "chat", ptLabel: "Chat", ptIcon: ptIconChat() },
    ],
  },
  {
    ptTitle: "PRODUTIVIDADE",
    ptItems: [
      { ptId: "metas", ptLabel: "Metas", ptIcon: ptIconFlag() },
      { ptId: "pomodoro", ptLabel: "Pomodoro", ptIcon: ptIconTimer() },
    ],
  },
]
...
export function Post() {
  const [ptActiveNav, ptSetActiveNav] = useState<string>("home")
